...
```{r echo=FALSE, out.width="700px"}
knitr::include_graphics("man/figures/strategies.png")
```
...
```{r echo=FALSE, out.width="700px"}
knitr::include_graphics("man/figures/s1v2a.png")
```

Reprojection (using `stars::st_warp()`) and Unsupervised Classification (using `RStoolbox::unsuperClass()`) using Strategy 2B and 3
```{r echo=FALSE, out.width="700px"}
knitr::include_graphics("man/figures/s2bv3.png")
```
```{r echo=FALSE, out.width="200px"}
knitr::include_graphics("man/figures/s_legend.jpeg")
```
