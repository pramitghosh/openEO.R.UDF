...
knitr::include_graphics("reference/figures/openeo_github.png")
```
...
```{r echo=FALSE, out.width="1000px"}
knitr::include_graphics("reference/figures/strategies.png")
```
...
```{r echo=FALSE, out.width="1000px"}
knitr::include_graphics("reference/figures/s1v2a.png")
```

Calculation of NDVI, Reprojection (using `stars::st_warp()`) and Unsupervised Classification (using `RStoolbox::unsuperClass()`) using Strategy 2B

```{r echo=FALSE, out.width="1000px"}
knitr::include_graphics("reference/figures/s2b.png")
```

Calculation of NDVI, Reprojection (using `stars::st_warp()`) and Unsupervised Classification (using `RStoolbox::unsuperClass()`) using Strategy 3

```{r echo=FALSE, out.width="1000px"}
knitr::include_graphics("reference/figures/s3.png")
```
